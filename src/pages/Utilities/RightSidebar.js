...
const RightSidebar = () => {
    ...
    return (
        <div className='flex md:justify-end md:absolute md:top-0 md:right-0 overflow-auto [height:100vh]'>
            ...
            {/* close button  */}
            <button className='bg-black top-2 right-2 absolute text-white w-10 h-10 rounded-full' data-tip="Close" data-place="top" data-effect="solid">
                            ...
                            <div className='mt-10'>
                                ...
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <div className='text-center mt-5'>
                                        <input type="text" className='input border-1 border-black w-full text-lg p-1' placeholder='Task Message' {...register('message', { required: true })} />
                                    </div>
