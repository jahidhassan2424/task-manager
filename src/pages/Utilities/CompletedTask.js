    ...
    return (
        <div>
            <div className='md:mx-10 h-1/2'>
                <h1 data-tip="Close" data-place="top" data-effect="solid"  className='md:text-3xl text-2xl my-5 py-3 font-bold text-center bg-neutral text-white  md:rounded-xl'>Your Completed Tasks</h1>
